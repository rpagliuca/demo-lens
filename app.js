...
function mockResponse(_real) {
  return {
    ...
    data: {
      image_features: {
        color_cls:        { color_index: 0, color: 'BRANCO',      confidence: 0.821 },
        brand_cls:        { brand_index: 0, brand: 'BRASTEMP',    confidence: 0.754 },
        product_type_cls: { product_type_index: 0, product_type: 'GELADEIRA', confidence: 0.937 },
      },
      sku_candidates: [
        { rank: 1, super_class: 3, agregated_features: 'GELADEIRA_BRASTEMP_FROST_FREE_419L', skus: ['DFX41BBBNA'], confidence: 0.622 },
        { rank: 2, super_class: 4, agregated_features: 'MAQUINA_LAVAR_SAMSUNG_11KG',         skus: ['WF5000HAWA', 'WF5000HAWABAZ'], confidence: 0.318 },
      ],
    },
  };
}
